...
@Component({
  selector: 'app-auth-gouv',
  templateUrl: './auth-gouv.component.html',
  styleUrls: ['./auth-gouv.component.css']
})
export class AuthGouvComponent implements OnInit {

  loginForm: FormGroup;
  private submitted = false;
  private error: any;
  private type = 'gouvernment';
